...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/DarkPayCoin/btcd/peer)
...
```bash
$ go get -u github.com/DarkPayCoin/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/DarkPayCoin/btcd/peer#example-package--NewOutboundPeer)  
