...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/DarkPayCoin/btcd/connmgr)
...
```bash
$ go get -u github.com/DarkPayCoin/btcd/connmgr
```
