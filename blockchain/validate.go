...
if height == 0 {
       return 21000 * btcutil.SatoshiPerBitcoin //premine for first MNs
    } else if height < 267 && height > 0 { // testing phase
        return 6.66 * btcutil.SatoshiPerBitcoin
    } else if height < 20000 && height > 266 { // warming phase
        return 4 * btcutil.SatoshiPerBitcoin
    } else if height <= 29999 && height >= 20000 { // GO !!
        return 40 * btcutil.SatoshiPerBitcoin
    } else if height <= 39999 && height >= 30000 {
        return 60 * btcutil.SatoshiPerBitcoin
    } else if height <= 49999 && height >= 40000 {
        return 80 * btcutil.SatoshiPerBitcoin
    } else if height <= 59999 && height >= 50000 {
        return 100 * btcutil.SatoshiPerBitcoin
    } else if height <= 69999 && height >= 60000 {
        return 120 * btcutil.SatoshiPerBitcoin
    } else if height <= 79999 && height >= 70000 {
        return 140 * btcutil.SatoshiPerBitcoin
    } else if height <= 89999 && height >= 80000 {
        return 160 * btcutil.SatoshiPerBitcoin
    } else if height <= 99999 && height >= 90000 {
        return 180 * btcutil.SatoshiPerBitcoin
    } else if height <= 109999 && height >= 100000 {
        return 200 * btcutil.SatoshiPerBitcoin
    } else if height <= 119999 && height >= 110000 {
        return 220 * btcutil.SatoshiPerBitcoin
    } else if height <= 129999 && height >= 120000 {
        return 240 * btcutil.SatoshiPerBitcoin
    } else if height <= 139999 && height >= 130000 {
        return 260 * btcutil.SatoshiPerBitcoin
    } else if height <= 149999 && height >= 140000 {
        return 250 * btcutil.SatoshiPerBitcoin
    } else if height <= 224999 && height >= 150000 {
        return 150 * btcutil.SatoshiPerBitcoin
    } else if height <= 299999 && height >= 225000 {
        return 125 * btcutil.SatoshiPerBitcoin
    } else if height <= 349999 && height >= 300000 {
        return 110 * btcutil.SatoshiPerBitcoin
    } else if height <= 399999 && height >= 350000 {
        return 105 * btcutil.SatoshiPerBitcoin
    } else if height <= 449999 && height >= 400000 {
        return 100 * btcutil.SatoshiPerBitcoin
    } else if height <= 951470 && height >= 450000 {
        return 85 * btcutil.SatoshiPerBitcoin
    } else {
