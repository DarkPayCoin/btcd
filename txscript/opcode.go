...
const (
	...
	OP_ZEROCOINMINT        = 0xc1 // 193
	OP_ZEROCOINSPEND       = 0xc2 // 194
...
var opcodeArray = [256]opcode{
	...
	OP_ZEROCOINMINT:  {OP_ZEROCOINMINT, "OP_ZEROCOINMINT", 1, opcodeNop},
	OP_ZEROCOINSPEND: {OP_ZEROCOINSPEND, "OP_ZEROCOINSPEND", 1, opcodeNop},
